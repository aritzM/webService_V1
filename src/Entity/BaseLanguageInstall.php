 ...
 * BaseLanguageInstall
 *
 * @ORM\Table(name="base_language_install", indexes={@ORM\Index(name="IDX_BF0A07884C10A2D2", columns={"create_uid"}), @ORM\Index(name="IDX_BF0A07887C455263", columns={"write_uid"})})
 * @ORM\Entity
 */
