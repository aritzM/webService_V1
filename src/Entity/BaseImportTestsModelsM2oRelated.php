 ...
 *
 * @ORM\Table(name="base_import_tests_models_m2o_related", indexes={@ORM\Index(name="IDX_B97C1D364C10A2D2", columns={"create_uid"}), @ORM\Index(name="IDX_B97C1D367C455263", columns={"write_uid"})})
 * @ORM\Entity
 */
