 ...
 *
 * @ORM\Table(name="base_import_tests_models_char_states", indexes={@ORM\Index(name="IDX_472B6CFA7C455263", columns={"write_uid"}), @ORM\Index(name="IDX_472B6CFA4C10A2D2", columns={"create_uid"})})
 * @ORM\Entity
 */
