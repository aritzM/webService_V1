 ...
 *
 * @ORM\Table(name="base_import_tests_models_char_readonly", indexes={@ORM\Index(name="IDX_1DBF4C824C10A2D2", columns={"create_uid"}), @ORM\Index(name="IDX_1DBF4C827C455263", columns={"write_uid"})})
 * @ORM\Entity
 */
