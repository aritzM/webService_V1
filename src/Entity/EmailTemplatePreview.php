 ...
 *
 * @ORM\Table(name="email_template_preview", indexes={@ORM\Index(name="email_template_preview_model_index", columns={"model"}), @ORM\Index(name="IDX_E404BCBE7C455263", columns={"write_uid"}), @ORM\Index(name="IDX_E404BCBE4C10A2D2", columns={"create_uid"}), @ORM\Index(name="IDX_E404BCBE3699AFE5", columns={"sub_model_object_field"}), @ORM\Index(name="IDX_E404BCBE1AFCE4A0", columns={"sub_object"}), @ORM\Index(name="IDX_E404BCBE7604BDD0", columns={"model_object_field"}), @ORM\Index(name="IDX_E404BCBE1D1F7BB8", columns={"ref_ir_act_window"}), @ORM\Index(name="IDX_E404BCBE970086FE", columns={"report_template"}), @ORM\Index(name="IDX_E404BCBE609EF8D4", columns={"mail_server_id"}), @ORM\Index(name="IDX_E404BCBE7975B7E7", columns={"model_id"})})
 * @ORM\Entity
 */
class EmailTemplatePreview
{
     ...
     * @ORM\SequenceGenerator(sequenceName="email_template_preview_id_seq", allocationSize=1, initialValue=1)
     */
    private $id;
     ...
     * @var string|null
     *
     * @ORM\Column(name="res_id", type="string", nullable=true, options={"comment"="Sample Document"})
     */
    private $resId;
