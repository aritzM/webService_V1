 ...
 * IrAttachment
 *
 * @ORM\Table(name="ir_attachment", indexes={@ORM\Index(name="ir_attachment_url_index", columns={"url"}), @ORM\Index(name="ir_attachment_res_idx", columns={"res_model", "res_id"}), @ORM\Index(name="ir_attachment_checksum_index", columns={"checksum"}), @ORM\Index(name="IDX_3FF011704C10A2D2", columns={"create_uid"}), @ORM\Index(name="IDX_3FF01170979B1AD6", columns={"company_id"}), @ORM\Index(name="IDX_3FF011707C455263", columns={"write_uid"})})
 * @ORM\Entity
 */
class IrAttachment
{
