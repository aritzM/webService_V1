 ...
 *
 * @ORM\Table(name="account_common_journal_report", indexes={@ORM\Index(name="IDX_4F0FCEB37C455263", columns={"write_uid"}), @ORM\Index(name="IDX_4F0FCEB34C10A2D2", columns={"create_uid"}), @ORM\Index(name="IDX_4F0FCEB3979B1AD6", columns={"company_id"})})
 * @ORM\Entity
 */
class AccountCommonJournalReport
{
     ...
     * @ORM\SequenceGenerator(sequenceName="account_common_journal_report_id_seq", allocationSize=1, initialValue=1)
     */
    private $id;
