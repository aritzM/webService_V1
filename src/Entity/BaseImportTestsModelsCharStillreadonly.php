 ...
 *
 * @ORM\Table(name="base_import_tests_models_char_stillreadonly", indexes={@ORM\Index(name="IDX_CB3C1FB94C10A2D2", columns={"create_uid"}), @ORM\Index(name="IDX_CB3C1FB97C455263", columns={"write_uid"})})
 * @ORM\Entity
 */
