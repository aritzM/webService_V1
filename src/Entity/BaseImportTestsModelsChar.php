 ...
 *
 * @ORM\Table(name="base_import_tests_models_char", indexes={@ORM\Index(name="IDX_6BAEC59B4C10A2D2", columns={"create_uid"}), @ORM\Index(name="IDX_6BAEC59B7C455263", columns={"write_uid"})})
 * @ORM\Entity
 */
