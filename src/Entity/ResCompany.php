 ...
 * ResCompany
 *
 * @ORM\Table(name="res_company", uniqueConstraints={@ORM\UniqueConstraint(name="res_company_name_uniq", columns={"name"})}, indexes={@ORM\Index(name="res_company_parent_id_index", columns={"parent_id"}), @ORM\Index(name="IDX_6DFC5DA19393F8FE", columns={"partner_id"}), @ORM\Index(name="IDX_6DFC5DA138248176", columns={"currency_id"}), @ORM\Index(name="IDX_6DFC5DA12FE4C5D9", columns={"paperformat_id"}), @ORM\Index(name="IDX_6DFC5DA14C10A2D2", columns={"create_uid"}), @ORM\Index(name="IDX_6DFC5DA17C455263", columns={"write_uid"})})
 * @ORM\Entity
 */
class ResCompany
{
