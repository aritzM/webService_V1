 ...
 * IrFilters
 *
 * @ORM\Table(name="ir_filters", uniqueConstraints={@ORM\UniqueConstraint(name="ir_filters_name_model_uid_unique", columns={"name", "model_id", "user_id", "action_id"}), @ORM\UniqueConstraint(name="ir_filters_name_model_uid_unique_action_index", columns={"model_id"})}, indexes={@ORM\Index(name="IDX_7930F506A76ED395", columns={"user_id"}), @ORM\Index(name="IDX_7930F5064C10A2D2", columns={"create_uid"}), @ORM\Index(name="IDX_7930F5067C455263", columns={"write_uid"})})
 * @ORM\Entity
 */
class IrFilters
{
