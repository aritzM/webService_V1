 ...
 * IrModuleCategory
 *
 * @ORM\Table(name="ir_module_category", indexes={@ORM\Index(name="ir_module_category_name_index", columns={"name"}), @ORM\Index(name="ir_module_category_parent_id_index", columns={"parent_id"}), @ORM\Index(name="IDX_3BB727C24C10A2D2", columns={"create_uid"}), @ORM\Index(name="IDX_3BB727C27C455263", columns={"write_uid"})})
 * @ORM\Entity
 */
