 ...
 * BaseModuleUpdate
 *
 * @ORM\Table(name="base_module_update", indexes={@ORM\Index(name="IDX_BA9D40EE4C10A2D2", columns={"create_uid"}), @ORM\Index(name="IDX_BA9D40EE7C455263", columns={"write_uid"})})
 * @ORM\Entity
 */
