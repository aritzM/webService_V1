 ...
 * IrCron
 *
 * @ORM\Table(name="ir_cron", indexes={@ORM\Index(name="IDX_4962FD7CC555687E", columns={"ir_actions_server_id"}), @ORM\Index(name="IDX_4962FD7CA76ED395", columns={"user_id"}), @ORM\Index(name="IDX_4962FD7C4C10A2D2", columns={"create_uid"}), @ORM\Index(name="IDX_4962FD7C7C455263", columns={"write_uid"})})
 * @ORM\Entity
 */
class IrCron
{
