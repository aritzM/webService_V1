 ...
 *
 * @ORM\Table(name="account_balance_report", indexes={@ORM\Index(name="IDX_1323F5E77C455263", columns={"write_uid"}), @ORM\Index(name="IDX_1323F5E74C10A2D2", columns={"create_uid"}), @ORM\Index(name="IDX_1323F5E7979B1AD6", columns={"company_id"})})
 * @ORM\Entity
 */
class AccountBalanceReport
{
     ...
     * @ORM\SequenceGenerator(sequenceName="account_balance_report_id_seq", allocationSize=1, initialValue=1)
     */
    private $id;
