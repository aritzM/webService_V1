 ...
 * BaseImportImport
 *
 * @ORM\Table(name="base_import_import", indexes={@ORM\Index(name="IDX_69C441BC4C10A2D2", columns={"create_uid"}), @ORM\Index(name="IDX_69C441BC7C455263", columns={"write_uid"})})
 * @ORM\Entity
 */
