 ...
 * IrModel
 *
 * @ORM\Table(name="ir_model", uniqueConstraints={@ORM\UniqueConstraint(name="ir_model_obj_name_uniq", columns={"model"})}, indexes={@ORM\Index(name="IDX_3D1E9A1D7C455263", columns={"write_uid"}), @ORM\Index(name="IDX_3D1E9A1D4C10A2D2", columns={"create_uid"})})
 * @ORM\Entity
 */
class IrModel
{
